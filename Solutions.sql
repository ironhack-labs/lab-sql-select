...
-------------
-- Challenge 3 - Best Selling Authors. the top 3 authors who have sold the highest number of titles? 
SELECT
    authors.au_id AS "AUTHOR ID", authors.au_lname AS "LAST NAME", authors.au_fname AS "FIRST NAME",
...
-------------
-- Challenge 4 - Best Selling Authors Ranking. the output will display all 23 authors instead of the top 3. Note that the authors who have sold 0 titles
SELECT
    authors.au_id AS "AUTHOR ID", authors.au_lname AS "LAST NAME", authors.au_fname AS "FIRST NAME",
